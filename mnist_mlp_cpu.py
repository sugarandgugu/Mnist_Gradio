...
class MNIST_MLP(object):
    ...
    def load_data(self):
        ...
        train_images = self.load_mnist('/opt/code_chap_2_3/code_chap_2_3_student/exp_2_2_mnist_mlp_dlp/mnist_data/train-images-idx3-ubyte', True)
        train_labels = self.load_mnist('/opt/code_chap_2_3/code_chap_2_3_student/exp_2_2_mnist_mlp_dlp/mnist_data/train-labels-idx1-ubyte',False)
        test_images = self.load_mnist('/opt/code_chap_2_3/code_chap_2_3_student/exp_2_2_mnist_mlp_dlp/mnist_data/t10k-images-idx3-ubyte',True)
        test_labels = self.load_mnist('/opt/code_chap_2_3/code_chap_2_3_student/exp_2_2_mnist_mlp_dlp/mnist_data/t10k-labels-idx1-ubyte',False)
    ...
    def load_model(self, param_dir):
        ...
        params = np.load(param_dir,encoding="latin1",allow_pickle=True).item()
    ...
    def backward(self):  # 神经网络的反向传播
        ...
        dh3 = self.fc3.backward(dloss) # 100,16
        # print(dh3.shape,type(dh3),dh3)
        dh2 = self.relu2.backward(dh3)
        dh1 = self.fc2.backward(dh2)
        dh0 = self.relu1.backward(dh1)
        self.fc1.backward(dh0)
...
def build_mnist_mlp(param_dir='/opt/mlp-784-16-1epoch.npy'):
    h1, h2, e = 784, 16, 5
...
if __name__ == '__main__':
    mlp = build_mnist_mlp()
    mlp.evaluate()
    mlp = MNIST_MLP(hidden1=784, hidden2=10, max_epoch=1)
    # mlp.load_model('/opt/mlp-784-16-1epoch.npy')
